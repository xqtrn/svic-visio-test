...
(async () => {
  ...
  await pg.goto('https://platform.siliconvalleyinvestclub.com/login?v=' + Date.now(), { waitUntil: 'domcontentloaded' });
  await pg.waitForTimeout(5000);
  await pg.screenshot({ path: 'out/login-gate.png' });
  ...
  await pg.screenshot({ path: 'out/white-head.png' });
  await b.close();
