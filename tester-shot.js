...
(async () => {
  ...
  await pg.goto('https://test.siliconvalleyinvestclub.com/__faces', { waitUntil: 'domcontentloaded' });
  ...
  await pg.goto('https://test.siliconvalleyinvestclub.com/', { waitUntil: 'domcontentloaded' });
  await pg.waitForTimeout(6000);
